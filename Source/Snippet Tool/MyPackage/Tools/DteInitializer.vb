...
#Region " Base Implementations "
        ...
        ''' </returns>
        ''' ----------------------------------------------------------------------------------------------------
        Private Function IVsShellPropertyEvents_OnShellPropertyChange(propid As Integer, var As Object) As Integer Implements IVsShellPropertyEvents.OnShellPropertyChange
