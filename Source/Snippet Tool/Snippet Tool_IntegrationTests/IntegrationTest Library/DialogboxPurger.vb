...
Imports Snippet_Tool_IntegrationTests.Microsoft.VsSDK.IntegrationTestLibrary

Namespace IntegrationTest_Library
	...
	Friend Class DialogBoxPurger
		...
		''' </summary>
        Friend Shared Mutex As Object = New Object()
        ...
        ''' </summary>
        Private ReadOnly threadDone As AutoResetEvent = New AutoResetEvent(False)

        ''' <summary>
        ''' The queued thread started.
        ''' </summary>
        Private ReadOnly threadStarted As AutoResetEvent = New AutoResetEvent(False)
        ...
        ''' </summary>
        Private ReadOnly numberOfDialogsToWaitFor As Integer = 1
